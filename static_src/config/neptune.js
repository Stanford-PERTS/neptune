...
export const HOSTING_DOMAIN = PERTS.HOSTING_DOMAIN || 'localhost:8080';
...
export const NEPTUNE_COOKIES_AUTH_USER = 'neptune:auth:user';
export const NEPTUNE_COOKIES_AUTH_TOKEN = 'neptune:auth:token';

const config = ngModule => {
  ngModule.value('serverTime', SERVER_TIME);
  ngModule.value('hostingProtocol', HOSTING_PROTOCOL);
  ...
  ngModule.value('passwordRegex', /\S{10,}/);
